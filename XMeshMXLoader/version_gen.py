...
"""
Generate Version Files for XMeshMXLoader
"""
...
BEGIN
	...
	BEGIN
		BLOCK "040904b0"
		BEGIN
			VALUE "Comments", "Thinkbox XMesh Loader"
			VALUE "CompanyName", "Thinkbox Software"
			VALUE "FileDescription", "XMesh Loader Dynamic Link Library"
			VALUE "FileVersion", "{major}.{minor}.{patch}"
			VALUE "InternalName", "XMeshLoader"
			VALUE "LegalCopyright", "Copyright (C) 2022"
			VALUE "OriginalFilename", "XMeshLoader.dlo"
			VALUE "ProductName", "XMeshLoader"
...
#define FRANTIC_DESCRIPTION "Thinkbox XMesh Loader for 3ds Max"
"""

def write_version_header(version: str, filename: str='XMeshLoaderVersion.h') -> None:
    """
...
def write_version_resource(version: str, filename: str='XMeshLoaderVersion.rc') -> None:
    """
