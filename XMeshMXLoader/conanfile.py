...
class XMeshMXLoaderConan(ConanFile):
    name: str = 'xmeshmxloader'
    version: str = '1.9.2'
    license: str = 'Apache-2.0'
    description: str = 'The XMesh Loader Plugin for 3ds Max'
    ...
    def build(self) -> None:
        version_gen.write_version_resource(self.version, os.path.join(self.source_folder, 'XMeshLoaderVersion.rc'))
        version_gen.write_version_header(self.version, os.path.join(self.source_folder, 'XMeshLoaderVersion.h'))
