...
class XMeshMXSaverConan(ConanFile):
    ...
    def build(self) -> None:
        version_gen.write_version_resource(self.version, os.path.join(self.source_folder, 'XMeshSaverVersion.rc'))
        version_gen.write_version_header(self.version, os.path.join(self.source_folder, 'XMeshSaverVersion.h'))
